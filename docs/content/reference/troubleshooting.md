...
Most of these come down to network reality or how osrm serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

osrm rate-limits like any public site. osrm already paces
...
Where a surface is gated, osrm reads a cookie or token you supply
...
`osrm`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what osrm actually did
